...
public class UserControllerTest {
    ...
    @Test
    public void testAddUser_ValidUserDTO_ReturnsCreated() {
        // Arrange
    ...
    @Test
    public void testAddUser_ExceptionThrown_ReturnsInternalServerError() {
        // Arrange
        UserDTO userDTO = new UserDTO(1L, "user1", "user1@example.com", "password1");
    ...
    @Test
    public void testUpdateUser_ValidUserDTO_ReturnsUpdatedUser() {
        // Arrange
        UserDTO userDTO = new UserDTO(1L, "user1", "user1@example.com", "password1");
        User user = new User(1L, "user1", "user1@example.com", "password1");
        Mockito.when(userService.convertToEntity(userDTO)).thenReturn(user);
    ...
    @Test
    public void testUpdateUser_ExceptionThrown_ReturnsInternalServerError() {
        // Arrange
        UserDTO userDTO = new UserDTO(1L, "user1", "user1@example.com", "password1");
    ...
    @Test
    public void testGetUserById_ExistingUserId_ReturnsUserDTO() {
        // Arrange
        Long userId = 1L;
        User user = new User(1L, "user1", "user1@example.com", "password1");
    ...
    @Test
    public void testGetUserById_NonExistingUserId_ReturnsNotFound() {
        // Arrange
        Long userId = 1L;
