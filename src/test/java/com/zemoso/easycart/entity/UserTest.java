...
class UserTest {
    ...
    @Test
    void testUserEntityWithAllPropertiesSet() {
    ...
    @Test
     void testUserEntityWithMissingProperties() {
    ...
    @Test
     void testUserEntityWithPartialPropertiesSet() {
    ...
    @Test
    void testUserEntityPropertyModification() {
